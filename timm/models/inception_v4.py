...
class InceptionV4(nn.Module):
    def __init__(self, num_classes=1000, in_chans=3, output_stride=32, drop_rate=0., global_pool='avg'):
        ...
        self.feature_info = [
            dict(num_chs=64, reduction=2, module='to_mixed5a.2'),
            dict(num_chs=160, reduction=4, module='to_mixed5a.3'),
            dict(num_chs=384, reduction=8, module='mixed6a.3'),
            dict(num_chs=1024, reduction=16, module='mixed7a.6'),
            dict(num_chs=1536, reduction=32, module='features.2'),
        ]
    ...
    def forward_features(self, x):
        to_mixed5a = self.to_mixed5a(x)
        mixed6a = self.mixed6a(to_mixed5a)
        mixed7a = self.mixed7a(mixed6a)
        features = self.features(mixed7a) 
        return features, mixed7a, mixed6a, to_mixed5a
    ...
    def forward(self, x):
        x, _, __, ___  = self.forward_features(x)
        features = x
